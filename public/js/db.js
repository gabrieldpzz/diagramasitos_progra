...
DB.redraw = function() {
	...
	$(document).on("click", '.draggable', function() {
		...
		$("#edit_form").append("<div id='table_attributes'><div id='edit_attribute_list'></div><input class='btn btn-info' type='button' value='Agregar atributo' id='add_attribute_btn' /></div>");
